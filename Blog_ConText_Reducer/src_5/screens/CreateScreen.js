...
import { addOneBlog } from '../context/BlogContext/2_actionCreators';
...
const CreateScreen = ({navigation}) => {
    ...
    return (
        <View>
            ...
            <Button onPress={()=> {valueBlogContext.dispatchBlog(addOneBlog({tieuDe,noiDung})); setNoiDung(""); setTieuDe("")}} title='Create Blog' />
        </View>
    );
};
