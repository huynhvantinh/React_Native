...
const CreateScreen = ({navigation}) => {
    ...
    return (
        <View>
            ...
            {/* <Button onPress={()=> {valueBlogContext.addOneBlog({tieuDe,noiDung, callBackResetInput: resetInput })}} title='Create Blog' /> */}
            {/* <Button onPress={()=> {valueBlogContext.addOneBlog({tieuDe,noiDung, callBackResetInput: resetInput }); goToIndexScreen()}} title='Create Blog' /> */}
