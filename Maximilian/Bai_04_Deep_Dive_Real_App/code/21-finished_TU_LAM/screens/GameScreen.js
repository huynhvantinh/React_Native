...
function GameScreen({ userNumber, onGameOver }) {
	...
	// const initialGuess = generateRandomBetween(minBoundary, maxBoundary, userNumber);//Sẽ có lúc bị lỗi vì tạo ra lỗi chạy vô số lần hàm generateRandomBetween
	...
	function nextGuessHandler(direction) {
        console.log(`Vo nextGuessHandler: Min = ${minBoundary} - Max = ${maxBoundary}, - currentGuess = ${currentGuess}`);
        ...
        console.log(`3: Min = ${minBoundary} - Max = ${maxBoundary}, - currentGuess = ${currentGuess} - newRndNumber = ${newRndNumber}`);
